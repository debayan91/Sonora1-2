            ...
            <div className={`min-h-screen flex flex-col ${bgColor}`}>
                ...
                <main className="flex-grow flex justify-center items-center px-4 py-12">
                    <div className={`w-full max-w-md ${cardBgColor} ${textColor} text-sm shadow-2xl rounded-lg p-8`}>
                        <h1 className="text-3xl md:text-4xl mb-6 text-center font-thin tracking-wider">Sign Up</h1>
                        <form onSubmit={handleSubmit} noValidate>
                            <InputField name="username" type="text" placeholder="Username" value={formData.username} onChange={handleInputChange}>
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 12C14.7614 12 17 9.76142 17 7C17 4.23858 14.7614 2 12 2C9.23858 2 7 4.23858 7 7C7 9.76142 9.23858 12 12 12Z" /><path d="M12 14C7.58172 14 4 17.5817 4 22H20C20 17.5817 16.4183 14 12 14Z" /></svg>
                            </InputField>
                            ...
                            <InputField name="confirmPassword" type={showPassword ? "text" : "password"} placeholder="Confirm Password" value={formData.confirmPassword} onChange={handleInputChange}>
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18 8H17V6C17 3.23858 14.7614 1 12 1C9.23858 1 7 3.23858 7 6V8H6C4.89543 8 4 8.89543 4 10V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V10C20 8.89543 19.1046 8 18 8ZM12 17C10.8954 17 10 16.1046 10 15C10 13.8954 10.8954 13 12 13C13.1046 13 14 13.8954 14 15C14 16.1046 13.1046 17 12 17ZM15 8H9V6C9 4.34315 10.3431 3 12 3C13.6569 3 15 4.34315 15 6V8Z" /></svg>
                            </InputField>

                            <div className="text-center">
                                <button onClick={generatePassword} className={`bg-transparent border-none ${mutedTextColor} hover:${textColor} pb-4 text-sm cursor-pointer`}>
                            ...
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <label className="flex items-center cursor-pointer text-xs">
                                    <input type="checkbox" name="acceptTerms" checked={formData.acceptTerms} onChange={handleInputChange} className="mr-2 h-4 w-4 accent-gray-500" required/>
                                    I accept the <a href="/tnc" className={`ml-1 ${linkColor}`}>Terms of Use</a>
                                </label>
                            </div>
                            ...
                            <div className={`text-center mt-6 text-sm ${mutedTextColor}`}>
                                Already have an account? <a href="/login" className={`${linkColor}`}>Sign in.</a>
                            </div>
                        </form>
                    </div>
                </main>
