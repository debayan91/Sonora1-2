...
const FHero = () => {
  ...
  return (
    <div style={underlineStyle}>
      ...
      `}</style>
      <div className={`h-[85vh] w-screen pt-[40vh] ${isDarkMode ? 'bg-black' : 'bg-white'} font-roboto text-100 relative`}>
        <div
          id="bottomnav"
        ...
        >
          <hr className={`w-[90%] border-t ${isDarkMode ? 'border-white/80' : 'border-black/80'}`} style={{ borderWidth: '0.5px' }} />
          <div className="h-[calc(40vh-17vh)] flex flex-col md:flex-row justify-center items-center text-[19px] gap-8 md:gap-16 tracking-[0.15em] font-roboto">
            ...
            <a href="/products" id="a4" className={`${isDarkMode ? 'hover:text-white/70' : 'hover:text-black/70'} transition-all duration-300`}>
              Store
            </a>
